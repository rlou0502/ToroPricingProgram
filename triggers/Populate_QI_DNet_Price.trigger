trigger Populate_QI_DNet_Price on REVVY__MnQuoteItem__c (before insert, before update) {
    ...
    for(REVVY__MnQuoteItem__c sl : sublines) {
    ...
    for(REVVY__MnQuoteItem__c  qisubLine : [select revvy__quote__r.REVVY__Account__c,
                                                revvy__quote__r.REVVY__Price_Date__c,
                                                revvy__quote__r.REVVY__Channel__c,
                                                revvy__quote__r.REVVY__PriceCountry__c,
                                                revvy__quote__r.REVVY__Segment__c,
                                                revvy__quote__r.REVVY__Currency__c,
                                                revvy__Catalog_Node__c, revvy__SuggestedPrice__c
                                                from  REVVY__MnQuoteItem__c where id in :qiSublineIds])
    {
        accountId = qisubLine.revvy__quote__r.REVVY__Account__c;
        priceDate = qisubLine.revvy__quote__r.REVVY__Price_Date__c; 
        qtChannel = qisubLine.revvy__quote__r.REVVY__Channel__c;
        qtCountry = qisubLine.revvy__quote__r.REVVY__PriceCountry__c;
        qtSegment = qisubLine.revvy__quote__r.REVVY__Segment__c;
        qtCurrency = qisubLine.revvy__quote__r.REVVY__Currency__c;
        break;
    }
    ...
    for(REVVY__MnQuoteItem__c sl : sublines) {
        if (Schema.sObjectType.REVVY__MnQuoteItem__c.fields.REVVY__SuggestedPrice__c.isAccessible()) {
